...
export default function App() {
  ...
  // Copy states for Solarman monitoring credentials helper
  const [copiedSolarEmail, setCopiedSolarEmail] = useState(false);
  const [copiedSolarPass, setCopiedSolarPass] = useState(false);
